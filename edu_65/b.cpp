...
ios::sync_with_stdio(0); cin.tie(0);
    ...
    if(p1.first == p2.first) {
        cout << arr[p1.second] << " " << arr[p1.first]  << " "<< arr[p2.second] << " ";
    }else if(p1.first == p2.second) {
        cout << arr[p1.second] << " " << arr[p1.first] << " " << arr[p2.first] << " ";
    }else if(p1.second == p2.first) {
        cout << arr[p1.first] << " "<< arr[p1.second] << " " << arr[p2.second] << " ";
    }else {
        cout << arr[p1.first] << " " << arr[p1.second] << " "<< arr[p2.first] << " ";
    }
