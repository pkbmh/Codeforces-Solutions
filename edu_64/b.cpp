...
bool is_safe(string str) {
    ...
    //if(str[0] == 'a' && str[str.length()-1] == 'z') return false;
    //if(str[0] == 'z' && str[str.length()-1] == 'a') return false;
...
ios::sync_with_stdio(0); cin.tie(0);
    ...
    while(t--) {
        ...
        for(char c : str)
         ...
         for(int i = 0; i < 26; ++i) 
             if(cnt[i]) {
                string st = string(cnt[i], char('a'+i));
                if(i&1){
                    o += st;
                    o_r = st + o_r;
                 } else {
         ...
         if(is_safe(e+o)) cout << e+o << endl;
         else if(is_safe(e_r+o)) cout << e_r+o << endl;
         else if(is_safe(e+o_r)) cout << e + o_r << endl;
         else if(is_safe(e_r+o_r)) cout << e_r + o_r << endl;
         else if(is_safe(o+e)) cout << o+e << endl;
         else if(is_safe(o_r+e)) cout << o_r+e << endl;
         else if(is_safe(o+e_r)) cout << o + e_r << endl;
         else if(is_safe(o_r+e_r)) cout << o_r + e_r << endl;
